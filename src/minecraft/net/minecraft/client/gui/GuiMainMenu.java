...
//                this.mc.getTextureManager().bindTexture(TITLE_PANORAMA_PATHS[k]);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
    	...
    	mc.getTextureManager().bindTexture(new ResourceLocation("CtrlMC/background.png"));
        ...
        GlStateManager.popMatrix();
        String s = "Minecraft 1.10 §6with  §3§lCtrlMC " + Reference.VERSION;
        ...
        String s1 = "§6Hacked by EscapeMC! Enjoy!";
        this.drawString(this.fontRendererObj, "§6Hacked by EscapeMC! Enjoy!", this.width - this.fontRendererObj.getStringWidth("§6Hacked by EscapeMC! Enjoy!") - 2, this.height - 10, -1);
